...
export function PokemonCard(props: { data: PokemonListItem }) {
  const router = useRouter();
  const { id, name, pokemontypes, pokemonsprites } = props?.data;
  ...
  return (
    <Card className="w-60  bg-gray-100 hover:scale-105 duration-300 ease-in-out">
      <CardHeader
        onClick={handleClick}
      ...
      >
        ...
        <img
          ...
          src={pokemonsprites[0].sprites.front_default}
